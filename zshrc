...
alias ipython='ipython --pdb --no-autoindent --no-pprint --no-banner --simple-prompt --no-confirm-exit '
alias ipython3='ipython3 --pdb --no-autoindent --no-pprint --no-banner --simple-prompt --no-confirm-exit '
alias rm='rm -I'
